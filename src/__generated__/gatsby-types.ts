...
declare namespace GatsbyTypes {
  ...
  type ContentfulWorks = ContentfulReference &
    ContentfulEntry &
    Node & {
      readonly contentful_id: Scalars["String"]
      readonly id: Scalars["ID"]
  ...
  type usersryohidakaportfoliosrccomponentsbreadcrumbsTsx512065377QueryVariables = Exact<{
    [key: string]: never
  }>

  type usersryohidakaportfoliosrccomponentsbreadcrumbsTsx512065377Query = {
    readonly site: Maybe<{
      readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, "title" | "siteUrl">>
    }>
  }

  type usersryohidakaportfoliosrccomponentsjsonldworksTsx507726266QueryVariables = Exact<{
    [key: string]: never
  }>

  type usersryohidakaportfoliosrccomponentsjsonldworksTsx507726266Query = {
    readonly site: Maybe<{
  ...
  type usersryohidakaportfoliosrccomponentsjsonldblogPostTsx507726266QueryVariables = Exact<{
    [key: string]: never
  }>

  type usersryohidakaportfoliosrccomponentsjsonldblogPostTsx507726266Query = {
    readonly site: Maybe<{
      readonly siteMetadata: Maybe<
        Pick<SiteSiteMetadata, "siteUrl" | "icon"> & {
          readonly author: Maybe<Pick<SiteSiteMetadataAuthor, "name">>
  ...
  type usersryohidakaportfoliosrctemplatesblogTsx3159585216QueryVariables = Exact<{
    [key: string]: never
  }>

  type usersryohidakaportfoliosrctemplatesblogTsx3159585216Query = {
    readonly site: Maybe<{
      readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, "title">>
    }>
  }

  type usersryohidakaportfoliosrccomponentsseoTsx3340016916QueryVariables = Exact<{
    [key: string]: never
  }>

  type usersryohidakaportfoliosrccomponentsseoTsx3340016916Query = {
    readonly site: Maybe<{
      readonly siteMetadata: Maybe<
  ...
  type usersryohidakaportfoliosrctemplatesindexTsx3159585216QueryVariables = Exact<{
    [key: string]: never
  }>

  type usersryohidakaportfoliosrctemplatesindexTsx3159585216Query = {
    readonly site: Maybe<{
      readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, "title">>
    }>
  }

  type usersryohidakaportfoliosrctemplatesworksTsx3159585216QueryVariables = Exact<{
    [key: string]: never
  }>

  type usersryohidakaportfoliosrctemplatesworksTsx3159585216Query = {
    readonly site: Maybe<{
      readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, "title">>
    }>
  }
  ...
  type BioQueryQuery = {
    readonly site: Maybe<{
      readonly siteMetadata: Maybe<{
        readonly author: Maybe<Pick<SiteSiteMetadataAuthor, "name" | "summary">>
        readonly social: Maybe<Pick<SiteSiteMetadataSocial, "twitter">>
      }>
    }>
  }
